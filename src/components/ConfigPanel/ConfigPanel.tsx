...
export const ConfigPanel = () => {
    ...
    const totalPrice = pricing.total + totalCartPrice;
            ...
            <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-gray-700">Anchura ({activeModule.width} mm)</label>
                        <input
                            type="range"
                        ...
                        <div className="flex justify-between text-xs text-gray-500">
                            <span>{DIMENSION_LIMITS.minWidth} mm</span>
                            <span>{DIMENSION_LIMITS.maxWidth} mm</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    {activeModule.levels.map((level, index) => (
                        <div key={level.id} className="p-3 bg-white rounded-md border border-gray-200 text-sm shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <label className="text-xs text-gray-500">Altura (mm)</label>
                                    <input
                                        type="number"
            ...
            <div className="fixed bottom-0 left-0 w-80 bg-white border-t p-4 shadow-lg z-20">
                <div className="flex justify-between items-end mb-2">
                    <div className="flex flex-col">
                        ...
                        {totalCartPrice > 0 && <span className="text-[10px] text-green-600 font-medium">+ Accesorios</span>}
                    </div>
