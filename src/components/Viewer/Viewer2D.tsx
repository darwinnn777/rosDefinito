        ...
        <div className="flex flex-col items-center justify-center h-full w-full p-4 overflow-hidden">
            <div className="bg-white p-4 shadow-sm border rounded-lg w-full h-full flex items-center justify-center">
                ...
                >
                    ...
                    {modules.map((module, mIndex) => {
                        ...
                        const moduleRender = (
                            <g key={module.id}>
                                    ...
                                    return (
                                        <g key={level.id}>
                                            ...
                                            <text
                                                ...
                                                y={y + beamHeight + 120}
                                                className="text-[80px] fill-gray-400 text-center"
                                                textAnchor="middle"
                                            >
                                                {level.material}
                                            </text>
                                            ...
                                            <text
                                                x={moduleEndX - 50}
                                                y={y + 50}
                                                className="text-[80px] fill-gray-500 font-mono text-right"
                                ...
                                <line
                                    x1={moduleStartX}
                                    y1={height + 200 + (mIndex % 2) * 150}
                                    x2={moduleEndX}
                                    y2={height + 200 + (mIndex % 2) * 150}
                                    stroke="#374151"
                                    strokeWidth="1"
                                />
                                <text
                                    x={moduleCenterX(moduleStartX, module.width)}
                                    y={height + 320 + (mIndex % 2) * 150}
                                    textAnchor="middle"
                                    className="text-[100px] fill-gray-700 font-bold"
                                >
                                    {module.width} mm
                                </text>
                            </g>
                    ...
                    <line x1={-200} y1={0} x2={-200} y2={height} stroke="#374151" />
                    <text x={-250} y={height / 2} textAnchor="end" className="text-[120px] fill-gray-700 font-bold" style={{ transform: `rotate(-90deg)`, transformOrigin: `${-250}px ${height / 2}px` }}>{height} mm</text>
