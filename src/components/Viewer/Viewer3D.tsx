...
// Constants for component dimensions (mm)
const UPRIGHT_WIDTH = 80;
const UPRIGHT_DEPTH = 80;
...
const Shelf = ({ width, depth, y, material }: { width: number, depth: number, y: number, material: MaterialType }) => {
    ...
    return (
        <mesh position={[0, y + 10, 0]} castShadow receiveShadow>
            <boxGeometry args={[width, 20, depth]} />
...
export const Viewer3D = () => {
    return (
        <div className="h-full w-full bg-gray-100">
            <Canvas shadows camera={{ position: [5000, 4000, 5000], fov: 50, far: 200000 }} gl={{ preserveDrawingBuffer: true }}>
                <Suspense fallback={null}>
                    ...
                    <Grid
                        ...
                        sectionColor="#64748b"
                    />
                    <OrbitControls makeDefault maxDistance={50000} minDistance={500} />
                </Suspense>
